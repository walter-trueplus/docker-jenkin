...
//                        'sortOrder' => 10,
     ...
     * @return array
     */
    public function addFormFieldLabel($label, $formElement, $sortOrder, $validation , $classes = '', $defaultValue = null, $notice = '', $disabled = false){
        $field = [
            'arguments' => [
                'data' => [
                    'config' => [
    ...
    public function addFormFieldSelectText(
        $component, $label, $options = [], $sortOrder, $validation = [], $defaultValue = null, $notice = '', $switcherConfig = null, $disabled = false
    ){
        $field = [
            'arguments' => [
                'data' => [
