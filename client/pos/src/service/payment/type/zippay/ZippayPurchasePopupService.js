...
export class ZippayPurchasePopupService extends AbstractPopupService {
    static className = 'ZippayPurchasePopupService';
    cssClassName = 'zippay';
    dialogTitle;
    dialogInput;
    dialogLoader;
    ...
    getModalBody() {
        ...
        this.dialogTitle.innerHTML = i18n.translator.translate('Please enter customer store code:');
    ...
    getModalFooter(service, confirmCallback, cancelCallback) {
        ...
        this.dialogConfirmButton.onclick = () => {
            ...
            return confirmCallback(this.dialogInput.value);
        };
    ...
    canStartProcessTransaction() {
        return this.dialogInput && this.dialogInput.value && this.dialogInput.value.length;
    }

    startProcessTransaction() {
        this.dialogInput.className = 'hidden';
    ...
    showPopup(service, confirmCallback, cancelCallback) {
        ...
        let modalBody   = this.getModalBody(service);
...
/** @type ZippayPurchasePopupService */
let zippayPurchasePopupService = ServiceFactory.get(ZippayPurchasePopupService);

export default zippayPurchasePopupService;